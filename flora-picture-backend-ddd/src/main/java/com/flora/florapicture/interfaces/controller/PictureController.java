package com.flora.florapicture.interfaces.controller;
...
import com.flora.florapicture.infrastructure.annotation.AuthCheck;
import com.flora.florapicture.infrastructure.api.aliyunai.AliYunAiApi;
import com.flora.florapicture.infrastructure.api.aliyunai.model.CreateOutPaintingTaskResponse;
import com.flora.florapicture.infrastructure.api.aliyunai.model.GetOutPaintingTaskResponse;
import com.flora.florapicture.infrastructure.api.imagesearch.ImageSearchApiFacade;
import com.flora.florapicture.infrastructure.api.imagesearch.model.ImageSearchResult;
import com.flora.florapicture.infrastructure.common.BaseResponse;
import com.flora.florapicture.infrastructure.common.DeleteRequest;
import com.flora.florapicture.infrastructure.common.ResultUtils;
import com.flora.florapicture.domain.user.constant.UserConstant;
import com.flora.florapicture.infrastructure.exception.BusinessException;
import com.flora.florapicture.infrastructure.exception.ErrorCode;
import com.flora.florapicture.infrastructure.exception.ThrowUtils;
import com.flora.florapicture.interfaces.assembler.PictureAssembler;
import com.flora.florapicture.interfaces.dto.picture.*;
import com.flora.florapicture.shared.auth.SpaceUserAuthManager;
import com.flora.florapicture.shared.auth.StpKit;
import com.flora.florapicture.shared.auth.annotation.SaSpaceCheckPermission;
import com.flora.florapicture.shared.auth.model.SpaceUserPermissionConstant;
...
import com.flora.florapicture.domain.picture.valueobject.PictureReviewStatusEnum;
import com.flora.florapicture.interfaces.vo.picture.PictureTagCategory;
import com.flora.florapicture.interfaces.vo.picture.PictureVO;
import com.flora.florapicture.application.service.PictureApplicationService;
import com.flora.florapicture.application.service.SpaceApplicationService;
import com.flora.florapicture.application.service.UserApplicationService;
...
//            }
    ...
    public BaseResponse<Page<PictureVO>> listPictureVOByPageWithCache(@RequestBody PictureQueryRequest pictureQueryRequest,
        ...
        String cacheKey = String.format("florapicture:listPictureVOByPage:%s", hashKey);
        // 1. 先从本地缓存中查询
